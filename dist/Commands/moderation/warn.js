...
class NameCommand extends BaseCommand_1.BaseCommand {
    ...
    run(base) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!number) {
                const embed = new discord_js_1.MessageEmbed().setAuthor(`Advertencia 🔩`).setDescription(`¿Estas seguro que deseas warnear a \n**${member.user.tag}**?`).setColor("DARK_PURPLE").setTimestamp();
                ...
                a.on("collect", (c) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (c.customId === "si") {
                        try {
                            yield new moderationManager_1.warnManager(member, base.member, reason, false).warn();
                ...
                try {
                    yield new moderationManager_1.warnManager(member, base.member, reason).warn();
                    base.channel.sendTyping();
