...
class NameCommand extends BaseCommand_1.BaseCommand {
    ...
    run(base) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield (0, socialCommandsManager_1.addImages)(base.args.slice(1), base.args[0]);
                return base.message.reply(`Se han subido \`${base.args.length}\` imagenes a la base de datos del comando \`${base.args[0]}\``);
            }
            catch (e) {
