...
class NameCommand extends BaseCommand_1.BaseCommand {
    ...
    run(base) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                var a = yield (0, socialCommandsManager_1.getFinalResult)(base.message, "hug");
            }
            catch (e) {
            ...
            const embed = new discord_js_1.MessageEmbed()
                ...
                .setImage(a.image)
                .setFooter(`${a.userS.username} lleva ${a.user} abrazos recibidos.`, a.userS.displayAvatarURL())
                .setColor("PURPLE");
